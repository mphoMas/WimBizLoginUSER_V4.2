...
// document.getElementById("edit").onclick = function () {
//     //const changeDetails = (user, newDetails) => {
//       //  const {Name, Surname,Contact} = newDetails;
...
//     })
//     .then(() => {
//         alert("First Name Update");
//         return db.collection('profile').doc(user.uid).update({
//             ['First_Name']: First_Name.value
